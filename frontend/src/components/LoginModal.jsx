    ...
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={onClose} style={{
          ...
          cursor: 'pointer', color: '#94a3b8', fontSize: 22, lineHeight: 1,
        }}>×</button>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Remember me */}
          <label style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '14px 0 18px', cursor: 'pointer' }}>
            <input
              type="checkbox"
              checked={remember}
            ...
            />
            <span style={{ fontSize: 14, color: '#64748b' }}>Remember for 30 days</span>
          </label>
          ...
          {error && (
            <div style={{
              ...
              padding: '11px 16px', marginBottom: 16, color: '#dc2626', fontSize: 13,
          ...
          <button type="submit" disabled={loading} style={{
            width: '100%', padding: '14px', background: '#3730a3', color: '#fff',
            border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 700,
            cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.75 : 1,
            fontFamily: 'DM Sans, sans-serif', transition: 'all 0.2s',
            boxShadow: loading ? 'none' : '0 4px 16px rgba(55,48,163,0.3)',
          }}>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#64748b' }}>
          ...
          <span style={{ color: '#3730a3', fontWeight: 600 }}>
            Just sign in — we'll create it automatically.
          </span>
        </p>
      </div>
    </div>
...
const inputStyle = {
  width: '100%', padding: '12px 40px 12px 14px', border: '1.5px solid #e2e8f0',
